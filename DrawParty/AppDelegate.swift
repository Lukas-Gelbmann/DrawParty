...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        UserDefaults.standard.register(defaults: [AppDelegate.notificationKey:false])
        print(UserDefaults.standard.bool(forKey: AppDelegate.notificationKey))
        UserDefaults.standard.set(false, forKey: AppDelegate.notificationKey)
        return true
    }
